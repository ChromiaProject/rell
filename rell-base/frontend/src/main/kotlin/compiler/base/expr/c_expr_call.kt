...
interface C_CallTypeHints {
    fun getTypeHint(index: Int?, name: Name?): C_TypeHint
}

object C_CallTypeHints_None: C_CallTypeHints {
    override fun getTypeHint(index: Int?, name: Name?) = C_TypeHint.NONE
}
...
class C_CallArgument(val index: Int, val name: C_Name?, val value: C_CallArgumentValue) {
    companion object {
        internal fun compileAttributes(
                ctx: C_ExprContext,
                args: List<S_CallArgument>,
                attrs: ImmMap<Name, R_Attribute>,
        ): List<C_CallArgument> {
    ...
    private class C_AttrsTypeHints(private val attrs: ImmMap<Name, R_Attribute>): C_CallTypeHints {
