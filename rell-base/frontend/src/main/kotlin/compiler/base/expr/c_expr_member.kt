...
abstract class C_TypeValueMember(optionalName: Name?): C_TypeMember(optionalName) {
...
class C_TypeValueMember_Function(
    ...
    private class V_TypeValueMember_FunctionCall(
        ...
        override fun lower(ctx: C_ExprContext, base: V_Expr) = call.lower(ctx, base)
...
class C_MemberAttr_SysProperty(
    ...
    private inner class V_MemberAttr_SysProperty(
        ...
        override fun calculator(): R_MemberCalculator =
            R_MemberCalculator_SysProperty(type, cBody, naming.fullNameLazy.value)
    ...
    class R_MemberCalculator_SysProperty(
        type: R_Type,
        val cBody: C_SysFunctionBody,
...
sealed class C_EntityAttrRef(
    ...
    companion object {
        ...
        val ROWID_RNAME = Name.of(ROWID_NAME)
