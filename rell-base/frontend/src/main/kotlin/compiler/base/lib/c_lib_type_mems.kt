...
abstract class C_TypeMember(val optionalName: Name?) {
...
sealed class C_LibTypeMembers<MemberT: C_TypeMember> {
    ...
    abstract fun getByName(name: Name): List<MemberT>
...
private class C_LibTypeMembers_Simple<MemberT: C_TypeMember>(
    ...
    private val byNameMembers: ImmMap<Name, ImmList<MemberT>> by lazy {
        this.allMembers
    ...
    override fun getByName(name: Name) = byNameMembers[name].orEmpty()
}
...
private class C_LibTypeMembers_Combined<MemberT: C_TypeMember>(
    ...
    override fun getByName(name: Name): List<MemberT> {
