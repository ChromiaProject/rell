...
class C_LibNamespace private constructor(
        ...
        private val namespaces: ImmMap<Name, C_LibNestedNamespace>,
        private val members: ImmMap<Name, C_NamespaceMember>,
) {
    ...
    abstract class Maker(val basePath: C_RFullNamePath) {
        abstract fun addMember(name: Name, member: C_NamespaceMember)
    ...
    class Builder private constructor(
        ...
        private val members = mutableMapOf<Name, C_NamespaceMember>()
        private val functions = mutableMultimapOf<Name, FuncCase>()
        private val namespaces = mutableMapOf<Name, NestedBuilder>()
        ...
        private fun checkNameConflict(name: Name, vararg maps: Map<Name, *>) {
    ...
    companion object {
        ...
        private val EMPTY = C_LibNamespace(C_RFullNamePath.of(ModuleName.EMPTY), immMapOf(), immMapOf())
...
private class C_LibNestedNamespace(
    ...
    fun toSysNsProto(b: C_SysNsProtoBuilder, memberFactory: C_LibNsMemberFactory, name: Name) {
