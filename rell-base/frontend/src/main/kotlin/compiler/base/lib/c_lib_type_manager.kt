...
class C_LibTypeManager(modules: List<C_LibModule>) {
    ...
    fun getStaticMembers(type: R_Type, name: Name): List<C_TypeStaticMember> {
    ...
    fun getValueMembers(type: R_Type, name: Name): List<C_TypeValueMember> {
    ...
    fun getAtImplicitAttrsByName(selfType: R_Type, attrName: Name): List<C_AtTypeImplicitAttr> {
