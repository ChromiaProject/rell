...
sealed class C_LibMemberFunction {
    ...
    abstract fun getDefaultArgIdeInfos(): Map<Name, C_IdeSymbolInfo>
...
sealed class C_SpecialLibMemberFunctionBody {
    ...
    abstract class Simple: C_SpecialLibMemberFunctionBody() {
        abstract fun compileCallSimple(
            ctx: C_ExprContext,
            callCtx: C_LibFuncCaseCtx,
            selfType: R_Type,
            args: ImmList<V_Expr>,
    ...
    abstract class Complex: C_SpecialLibMemberFunctionBody() {
        abstract fun callParameters(selfType: R_Type): C_FunctionCallParameters

        abstract fun compileCallComplex(
            ctx: C_ExprContext,
            callCtx: C_LibFuncCaseCtx,
            selfType: R_Type,
            args: C_FullCallArguments,
    ...
    private class V_MemberFunctionCall_SpecialLibFunction(
        ...
        override fun lower(ctx: C_ExprContext, base: V_Expr) = specialCall.lower(ctx, base)
...
abstract class V_SpecialMemberFunctionCall(
...
class C_SpecialLibMemberFunction(
    ...
    override fun getDefaultArgIdeInfos() = immMapOf<Name, C_IdeSymbolInfo>()
