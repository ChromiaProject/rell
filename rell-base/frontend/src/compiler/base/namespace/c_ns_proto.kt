...
import net.postchain.rell.base.compiler.vexpr.V_ObjectExpr
...
class C_NsEntry(val name: Name, val member: C_NamespaceMember) {
...
class C_LibNsMemberFactory(private val basePath: C_RFullNamePath) {
    ...
    fun type(name: Name, typeDef: C_LibTypeDef, restrictions: C_MemberRestrictions): C_NamespaceMember {
    ...
    fun sysEntity(name: Name, entity: R_EntityDefinition, ideInfo: C_IdeSymbolInfo): C_NamespaceMember {
...
class C_SysNsProtoBuilder {
    ...
    fun addMember(name: Name, member: C_NamespaceMember) {
        check(!completed)
