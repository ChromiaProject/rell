...
sealed class C_VarPathItem {
    ...
    private data class C_VarPathItem_MemberAttr(private val name: Name, private val attr: C_MemberAttr): C_VarPathItem() {
    ...
    companion object {
        ...
        fun forMemberAttr(name: Name, attr: C_MemberAttr): C_VarPathItem = C_VarPathItem_MemberAttr(name, attr)
    }
}
