...
internal class XtextActionEx(val action: XtextAction, val transform: ((Any) -> Any)?)

internal sealed class XtextAction {
    abstract fun generate(type: String): List<String>
}

internal class XtextAction_Token(private val name: String?): XtextAction() {
...
internal class XtextAttr(val name: String, val many: Boolean)

internal class XtextAction_General(private val attrs: ImmList<XtextAttr>): XtextAction() {
