...
object IdeApi {
    ...
    @JvmStatic fun parseModuleName(s: String): ModuleName? {
        return ModuleName.ofOpt(s)
    }

    @JvmStatic fun getModuleName(path: C_SourcePath, ast: S_RellFile): ModuleName? {
    ...
    @JvmStatic fun getRellVersionInfo(): Map<*, String>? = C_LibBridge.instance.getRellVersionInfo()
