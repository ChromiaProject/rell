...
class NullAnalysisPathTest: BaseRellTest(false) {
    ...
    @Test fun testAtExprEntityWhere() {
        initEntity()
    ...
    @Test fun testAtExprEntityWhereMore() {
        initEntity()
    ...
    @Test fun testAtExprCollectionWhere() {
        tst.strictToString = false
    ...
    @Test fun testAtExprCollectionAttrName() {
        initFooBar()
    ...
    @Test fun testAtExprVersionControl() {
        initFooBar()
