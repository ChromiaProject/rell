...
class Ld_ConstructorHeader(
    ...
    fun finish(ctx: Ld_TypeFinishContext, fullName: FullName, memberHeader: L_MemberHeader): Finish {
...
class Ld_Constructor(
    ...
    fun finish(ctx: Ld_TypeFinishContext, fullName: FullName, lMemberHeader: L_MemberHeader): Finish {
