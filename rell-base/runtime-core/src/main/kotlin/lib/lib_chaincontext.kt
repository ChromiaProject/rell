...
private object C_NsProperty_ChainContext_Args: C_NamespaceProperty() {
    ...
    private class FnArgs(private val moduleName: ModuleName): R_SysFunctionEx_N() {
    ...
    private data class C_ModuleArgsVarId(private val moduleName: ModuleName): C_VarId() {
