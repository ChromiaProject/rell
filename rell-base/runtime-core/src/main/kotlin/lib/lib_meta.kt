...
private object C_SysFn_Meta: C_SysFn_BaseMeta(R_RellMetaType) {
    override fun getResultValue(meta: R_DefinitionMeta) = RR_ConstantValue.Meta(
        kind = meta.kind,
        moduleName = meta.moduleName,
        fullName = meta.fullName,
        simpleName = meta.simpleName,
        mountName = meta.mountName.str(),
    )
}
...
private object C_SysFn_Meta_CurrentModule: C_SpecialLibGlobalFunctionBody() {
    ...
    override fun compileCall(ctx: C_ExprContext, name: LazyPosString, args: ImmList<S_Expr>): V_Expr {
        ...
        val value = RR_ConstantValue.Meta(
            kind = meta.kind,
            moduleName = meta.moduleName,
            fullName = meta.fullName,
            simpleName = meta.simpleName,
...
internal object R_RellMetaType: R_LibUniqueType("rell.meta", C_DefinitionName("rell", "rell.meta")) {
