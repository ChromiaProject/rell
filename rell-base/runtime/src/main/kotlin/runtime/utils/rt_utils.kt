...
internal fun Boolean.toGtv(): Gtv = GtvFactory.gtv(this)
internal fun Int.toGtv(): Gtv = GtvFactory.gtv(this.toLong())
internal fun Long.toGtv(): Gtv = GtvFactory.gtv(this)
internal fun String.toGtv(): Gtv = GtvFactory.gtv(this)
internal fun BlockchainRid.toGtv(): Gtv = GtvFactory.gtv(this.data)

@JvmName("listOfGtvToGtv")
internal fun List<Gtv>.toGtv(): Gtv = GtvFactory.gtv(this)

@JvmName("listOfStringToGtv")
internal fun List<String>.toGtv(): Gtv = GtvFactory.gtv(this.map { it.toGtv() })

internal fun Map<String, Gtv>.toGtv(): Gtv = GtvFactory.gtv(this)
