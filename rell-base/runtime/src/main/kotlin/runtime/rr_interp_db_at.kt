...
private fun Rt_Interpreter.createGroupRExprCache(
 ...
 */
private fun Rt_Interpreter.applyFieldGroups(
 ...
 */
private fun Rt_Interpreter.applyGroup(
    group: RR_DbAtWhatFieldGroup,
...
private fun Rt_Interpreter.applyCombiner(
...
fun Rt_Interpreter.evaluateAtExtras(extras: RR_AtExtras, frame: Rt_CallFrame): Rt_AtExprExtras {
 ...
 */
private fun Rt_Interpreter.evaluateColAtWithNativeSummarization(
    expr: RR_Expr.ColAt,
    frame: Rt_CallFrame,
...
private fun Rt_Interpreter.aggregateValue(
...
private fun Rt_Interpreter.finalizeAggregatedValue(
    info: RR_ColAtFieldSummarizationInfo,
    value: Rt_Value?,
): Rt_Value = when (info.kind) {
