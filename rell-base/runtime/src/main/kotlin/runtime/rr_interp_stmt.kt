...
fun Rt_Interpreter.initializeDeclarator(decl: RR_VarDeclarator, frame: Rt_CallFrame, value: Rt_Value) {
    when (decl) {
        ...
        is RR_VarDeclarator.Wildcard -> { /* discard */
        }
    }
}

fun Rt_Interpreter.assignTo(
    dstExpr: RR_Expr,
    frame: Rt_CallFrame,
    value: Rt_Value,
    op: RR_BinaryOp?,
