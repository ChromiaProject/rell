...
fun Rt_Interpreter.evaluateUnary(expr: RR_Expr.Unary, frame: Rt_CallFrame): Rt_Value {
...
fun Rt_Interpreter.evaluateWhen(expr: RR_Expr.When, frame: Rt_CallFrame): Rt_Value {
 ...
 */
fun Rt_Interpreter.evaluateWhenChooser(chooser: RR_WhenChooser, frame: Rt_CallFrame): Int = when (chooser) {
...
fun Rt_Interpreter.evaluateFunctionCall(expr: RR_Expr.FunctionCall, frame: Rt_CallFrame): Rt_Value =
...
fun Rt_Interpreter.evaluateMemberAccess(expr: RR_Expr.MemberAccess, frame: Rt_CallFrame): Rt_Value {
...
fun Rt_Interpreter.evaluateMemberCalculator(
...
fun Rt_Interpreter.evaluateDataAttributeAccess(
    base: Rt_Value,
...
fun Rt_Interpreter.evaluateTypeAdapter(expr: RR_Expr.TypeAdapter, frame: Rt_CallFrame): Rt_Value {
    val value = evaluateExpr(expr.expr, frame)
    return applyTypeAdapter(expr.adapter, value)
}

fun Rt_Interpreter.applyTypeAdapter(adapter: RR_TypeAdapter, value: Rt_Value): Rt_Value = when (adapter) {
...
fun Rt_Interpreter.evaluateAttributeDefaultValue(expr: RR_Expr.AttributeDefaultValue, frame: Rt_CallFrame): Rt_Value {
