...
class Ld_StructDslImpl(
    ...
    private val attributes = mutableMapOf<Name, Ld_StructAttribute>()
...
class Ld_StructAttribute(
    ...
    fun finish(ctx: Ld_TypeFinishContext, outerFullName: FullName): L_StructAttribute {
...
class Ld_Struct(
    ...
    fun process(ctx: Ld_NamespaceContext, fullName: FullName): FcFuture<L_Struct> {
