...
class InterpreterBenchmark {
    ...
    private lateinit var interpreter: Rt_Interpreter
    ...
    fun setUp() {
        ...
        interpreter = Rt_Interpreter.forCompilation(rrApp, cRes.compilationSysFns)
        ...
        val appCtx = Rt_AppContext(globalCtx, Rt_ChainContext.NULL, interpreter)
        ...
        query = rrApp.moduleMap[ModuleName.EMPTY]!!.queries.getValue("bench")
    }
