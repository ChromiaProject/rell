...
- If the `indexCaching` option is set to true in the client initialization event, the Language Server caches the
  ...
  the [RellIndexCachingService](../../src/main/kotlin/net/postchain/rell/toolbox/lsp/caching/RellIndexCachingService.kt)
...
- The [RellIndexSerializer](../../src/main/kotlin/net/postchain/rell/toolbox/lsp/caching/RellIndexSerializer.kt) class
  manages the serialization and deserialization process.
- What gets cached is a serializable representation of document
  resource, [SerializableResource](../../src/main/kotlin/net/postchain/rell/toolbox/lsp/caching/SerializableResource.kt).
...
serializer [IdeSymbolIdSerializer](../../src/main/kotlin/net/postchain/rell/toolbox/lsp/caching/IdeSymbolIdSerializer.kt)
