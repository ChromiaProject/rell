...
class JavascriptCodegenITTest {
    ...
    fun `integration test project uses latest postchain-client`() {
        ...
        if (!isUpToDateNpmSpec(spec, latest)) {
            throw AssertionError(
                "Please update the JavaScript integration-test client to the latest postchain-client.\n" +
    ...
    companion object {
        ...
        fun setup() {
            ...
            nodeContainer = GenericContainer("node:22@sha256:0557ac14e0d45d02ed563067b82856ca5e7aa3437fa28d98d4350ea9c3d9494a").apply {
    ...
    private fun readPackageJsonText(): String {
        val path = "/integration_test_project/frontend/javascript/package.json"
        return checkNotNull(this::class.java.getResource(path)) { "$path not found on test classpath" }.readText()
    }
