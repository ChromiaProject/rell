    ...
    public static Object process(AntlrToRellContext ctx, ParserRuleContext node) {
        ...
        switch (node.getRuleIndex()) {
            ...
            case RULE_ruleX_GenericTypeExpr: {
                ...
                Object param_1 = ObjectUtils.firstNonNull(node.getRuleContext(RuleX_BaseExprTailMemberContext.class, 0),
            ...
            case RULE_ruleX_EnumDef: {
                ...
                List<?> enumElements = node.getRuleContexts(RuleX_NameContext.class);
            ...
            case RULE_ruleX_ImportTarget: {
                ...
                Object param_1 = ObjectUtils.firstNonNull(
