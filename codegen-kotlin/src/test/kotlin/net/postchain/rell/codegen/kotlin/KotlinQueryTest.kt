...
internal class KotlinQueryTest {
    ...
    @CsvSource(
            ...
            "return_type_nullable_entity,).let { nullable -> if (nullable is GtvNull) null else nullable.let { RowId(it.asInteger()) } }",
            "return_type_struct,).toObject<TestStruct>()",
            "return_type_rowid,).let { RowId(it.asInteger()) }",
            "return_type_nullable_rowid,).let { nullable -> if (nullable is GtvNull) null else nullable.let { RowId(it.asInteger()) } }",
            "return_type_gtv,)",
            "return_type_nullable_gtv,).let { nullable -> if (nullable is GtvNull) null else nullable }",
